...
//     function (num) { //functions with no name, called: anonymous function
//         return (
//             num * num
//         )
//     }
...
const newObjectFromArray = donuts.reduce(
    (accum, item) => /** evolved way of writing functions*/ {
...
let stringSortArray = ["ABS", "giraffe", "Giraffe", "apple", "orange", "tortoise", "peanut", "penguin", "hare"] //uppercase comes before lowercase, then alphabetical - preferrable ALL lowercase/uppercase
