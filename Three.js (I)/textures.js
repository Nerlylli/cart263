...
water_texture.colorSpace = THREE.SRGBColorSpace; //need to ensure that the textures are encoded correctly - mapping the colors correctly.

const material = new THREE.MeshBasicMaterial({ map: water_texture })
material.color = new THREE.Color('#9458dd')
...
scene.add(sphere, plane, torus) //torus is the donut
// //A: the geometry
