...
function setup() {
    ...
    //     /***CODE */
    //     let fifthParagraph = document.getElementById("6");
     ...
     * 
     * Then in the function customCreateElement(parent), I created a new paragraph. I changed the content of the text, the color is white and the background color is green by calling newPara.
     * 
     ...
     * 
     * Since there are 9 paragraphs the loop runs 9 times and there is a new paragraph with the properties that I set
     * in each one
     */
    ...
    for (let row = 0; row < 10; row++) {
        for (let col = 0; col < 10; col++) {
            ...
            if (row % 2 === 0) {
                ...
                returnedDiv.textContent = "0DD";
            }
        }
    }
    /***EXPLANATION::
     * Created a new function called customNewBoxCreate(parent)
     * Created a new div element that has a class called testDiv and appended it to the parent variable
     * The last line return newDIv, save the box into a new variable outside the function to do more things to it later
     * Created a grid that is 10x10 and saved newDiv into returnedDiv every time customNewBoxCreate is called
     * Adjusted the position of the grid
     * Made every row is divisible by 2 say "even" and white and every odd one say "odd" and purple
     */
   ...
   then the second a background of orange and the third yellow. */
    ...
    /***EXPLANATION::
     * Created a newDiv using the same function
     * Determined the raminder when dividing the column by 3
     * Assigned background color based on remainder
     * Displayed the remainder as the text (0,1,2)
     */
